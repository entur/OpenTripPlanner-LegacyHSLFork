...
public class TimeUtils {
   ...
   * to a given client request. Wait a bit and make another request, and you will enter busy-wait
   * again.
   * <p>
   * This method do a "busy" wait - it is not affected by a thread interrupt like
   * {@link Thread#sleep(long)}; Hence do not interfere with timeout logic witch
