...
public abstract class McStopArrival<T extends RaptorTripSchedule> implements ArrivalView<T> {
  ...
  public static <
    T extends McStopArrival<?>
  > ParetoComparator<T> compareArrivalTimeRoundCostAndOnBoardArrival(final RelaxFunction relaxC1) {
    return (l, r) -> relaxedCompareBase(relaxC1, l, r) || compareArrivedOnBoard(l, r);
  }
