...
| [relaxRaptorCostCriteria](#rd_relaxRaptorCostCriteria)                                           |        `double`        | Whether non-optimal transit paths should be returned                                                                               | *Optional* | `-1.0`                   |  2.3  |
...
<h3 id="rd_relaxRaptorCostCriteria">relaxRaptorCostCriteria</h3>
