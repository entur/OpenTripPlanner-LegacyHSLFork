...
public class OtpTransitServiceBuilderLimitPeriodTest {
  ...
  public void testLimitPeriod() {
    ...
    assertEquals(2, patternInT1.getScheduledTimetable().getTripTimes().count());
    assertEquals(1, patternInT2.scheduledTripsAsStream().count());
    assertEquals(1, patternInT2.getScheduledTimetable().getTripTimes().count());
    ...
    assertEquals(1, patternInT1.getScheduledTimetable().getTripTimes().count());
    assertEquals(
      tripCSIn,
      patternInT1.getScheduledTimetable().getTripTimes().findFirst().orElseThrow().getTrip()
    );
