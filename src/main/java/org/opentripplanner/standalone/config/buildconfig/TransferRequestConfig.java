...
public class TransferRequestConfig {
  ...
  public static List<RegularRouteRequest> map(NodeAdapter root, String transferRequestsName) {
    return root
...
"""
      ...
      .asObjects(List.of(new RegularRouteRequest()), RouteRequestConfig::mapRouteRequest);
  }
}
