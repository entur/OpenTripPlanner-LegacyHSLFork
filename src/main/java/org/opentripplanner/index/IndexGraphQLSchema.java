...
public class IndexGraphQLSchema {
    ...
    private Agency getAgency(GraphIndex index, String agencyId) {
        return index.getAgencyWithoutFeedId(agencyId);
    ...
    public IndexGraphQLSchema(GraphIndex index) {
        ...
        GraphQLInputObjectType bannedInputType = GraphQLInputObjectType.newInputObject()
            ...
            .field(GraphQLInputObjectField.newInputObjectField()
                .name("routes")
                .description("Do not use certain named routes Example: routes:\"RB__FLT:Line:1\"")
                .type(Scalars.GraphQLString)
                .build())
            .field(GraphQLInputObjectField.newInputObjectField()
                .name("agencies")
                .description("Do not use certain named agencies Example: agencies:\"NSB:Authority:NSB---\"")
                .type(Scalars.GraphQLString)
                .build())
            .field(GraphQLInputObjectField.newInputObjectField()
                .name("trips")
        ...
        GraphQLInputObjectType whiteListedInputType = GraphQLInputObjectType.newInputObject()
                ...
                .field(GraphQLInputObjectField.newInputObjectField()
                        .name("routes")
                        .description("Only use certain named routes. Example: routes:\"RB__FLT:Line:1\"")
                        .type(Scalars.GraphQLString)
                        .build())
                .field(GraphQLInputObjectField.newInputObjectField()
                        .name("agencies")
                        .description("Only use certain named agencies. Example: agencies:\"NSB:Authority:NSB---\"")
                        .type(Scalars.GraphQLString)
                        .build())
                .build();
