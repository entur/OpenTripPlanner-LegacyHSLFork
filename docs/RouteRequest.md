...
| [relaxCostAtDestination](#rd_relaxCostAtDestination)                                             |        `double`        | Whether non-optimal transit paths should be returned                                                                               | *Optional* | `-1.0`                   |  2.3  |
...
<h3 id="rd_relaxCostAtDestination">relaxCostAtDestination</h3>
